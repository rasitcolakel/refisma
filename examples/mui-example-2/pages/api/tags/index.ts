...
const endpoints = [
    {
        ...
        handler: async (req: createRequest, res: NextApiResponse) =>
            validateSchema(createTagSchema)(req, res, async (req: createRequest, res: NextApiResponse) => {
                try {
    ...
    },
    {
        ...
        handler: async (req: findManyRequest, res: NextApiResponse) =>
            validateSchema(findManyTagSchema)(req, res, async (req: findManyRequest, res: NextApiResponse) => {
                try {
