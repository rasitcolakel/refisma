...
export const createCategory = async (data: CategorySchema.CategoryCreateType) => {
...
export const updateCategory = async (data: CategorySchema.CategoryUpdateType) => {
...
export const deleteCategory = async (data: CategorySchema.CategoryDeleteType) => {
...
export const getOneCategory = async (data: CategorySchema.CategoryFindOneType) => {
...
export const getManyCategory = async (data: CategorySchema.CategoryFindManyType) => {
    const { query } = data
